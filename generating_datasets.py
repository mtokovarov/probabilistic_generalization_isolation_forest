...
if __name__ == '__main__':
    ...
    overlapping  = False
    target_path = 'generated_data'
    if(not os.path.exists(target_path)):
        os.mkdir(target_path)
    
    for dim_cnt in dim_cnts:
        ...
        data = np.zeros((ds_cnt, total_sample_cnt, dim_cnt))
        labels = np.zeros((ds_cnt, total_sample_cnt))
        data_file_path = f'{target_path}\\artificially_generated_{dim_cnt}_dimensions.npz'
